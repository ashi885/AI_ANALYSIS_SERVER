...
export { 
    getLicenseFromFileCache as getLicenseFromCache,
    refreshClientInFileCache as refreshLicenseInCache,
    invalidateClientInFileCache as invalidateLicenseInCache,
    getFileCacheStats as getLicenseCacheStats,
    getFileCacheDetails as getLicenseCacheDetails,
    initializeFileCache as initializeLicenseCache
} from './file-cache';
